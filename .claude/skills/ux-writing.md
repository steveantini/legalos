...
> **Project-specific note (legal audience):** Users are in-house lawyers.
> Copy is clear and direct without being glib. Avoid cutesy empty states
> ("Oops!", "Whoops, nothing here!") — legal audiences read them as
> unserious. Error messages state what happened, why, and what to do next.
> Button labels use plain verbs ("Save changes", "Generate draft", not
> "Let's go!"). Professional tone by default; restraint over personality.
