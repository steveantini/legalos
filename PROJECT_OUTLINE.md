...
- **What's next:** `docs/ROADMAP.md` is the authoritative ordered list (19 prioritized items plus a 9-item backlog). Item 1 (Share & connector hub) is the current top priority following the workspace home and Matters arc closure; it is also what flips the home's dormant Today and Matters gates live. The operator may reorder or pivot at any time.
