...
- **What's next:** `docs/ROADMAP.md` is the authoritative ordered list (21 prioritized items plus a 9-item backlog). Item 1 (Share & connector hub) is the current top priority following the chat attachments arc closure; the operator may reorder or pivot at any time.
