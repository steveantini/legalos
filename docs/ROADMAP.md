...
- **2b — the MCP client + OAuth 2.1 connect/auth + tools/list at connect.** Decomposed into three steps (the chat hot path stays untouched throughout Phase 1):
  ...
  - **2b-iii — tools/list-at-connect + store + show connected.** Call the 2b-i client at connect time, store the connection and its discovered tools, and surface it as connected.
