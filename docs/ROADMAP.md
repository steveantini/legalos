...
- **2c — the connector UI + per-org narrowing.** The Policy & access surface to connect a trusted/self-hosted MCP server, show it connected with its discovered tools, and let a super admin narrow (never widen) the code allowlist for the org.
